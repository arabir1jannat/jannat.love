...
\033[92;1m➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ SKB•⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
\033[33m【•】⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤
\033[1;32m【•】Cʀᴇᴀᴛᴇᴅ Bʏ   :  SKB•
\033[1;32m【•】Oɴ telegram  :  ***
\033[1;32m【•】Tᴏᴏʟ SᴛᴀᴛᴜS  :  FREE  
\033[1;32m【•】Tᴏᴏʟ Vᴇʀsɪᴏɴ :  1.6
\033[33m【•】⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤
{}
    ㅤㅤㅤㅤㅤ  INDONESIA
{}'''.format('\n',50*'-',50*'-')
...
try:
	...
	android = random.choice(['TECNO', "vivo", "INFINIX", "SAMSUNG"])
	model = random.choice(['LD2', " 1906", "SM-J009", "SM-J505", "HOT12", "NOTE-11", "A5-PRO"])
...
def main_menu():
	...
	print(50*'-')
	print('\033[1;32m(01)\033[1;32m ▪︎SIMPLE FILE CREATE▪︎ ')
	print('\033[1;32m(02)\033[1;91m ▪︎UNLIMITED FILE CREATE▪︎')
	print('\033[1;32m(03)\033[1;34m ▪︎NEW IDZ FILE CREATE▪︎ ')
	print('\033[1;32m(04)\033[1;33m ▪︎CREATE FILE USING—FILE▪︎')
	print('\033[1;32m(05)\033[1;35m ▪︎SEPERATE IDZ—CHOOZE YOUR LINK▪︎ ')
	print('\033[1;32m(06)\033[1;32m ▪︎SEPERATE IDZ▪︎ ')
	print('\033[1;32m(07)\33[1;96m ▪︎SHORTEN ID▪︎ ')
	print('\033[1;32m(08)\x1b[0;34m ▪︎REMOVE DUPLICATE IDZ▪︎ ')
	print('\033[1;32m(09)\033[93m ▪︎LARGE FILE—DIVIDER▪︎')
	print('\033[1;91m(10)\033[1;91m ▪︎REMOVE COOKIE▪︎ ')
	print('\033[1;91m(00)\033[1;91m ▪︎Exit tool▪︎ ')
	print(50 * '-')
	menu = input('\033[1;32mChoose Option >> ')
	if menu in ['01','1']:
